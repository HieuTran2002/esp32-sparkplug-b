...
typedef struct _org_eclipse_tahu_protobuf_Payload_Template_Parameter {
    ...
    union _org_eclipse_tahu_protobuf_Payload_Template_Parameter_value {
        uint32_t int_value;
        uint64_t long_value;
        float float_value;
        double double_value;
...
typedef struct _org_eclipse_tahu_protobuf_Payload_DataSet_DataSetValue {
    pb_size_t which_value;
    union _org_eclipse_tahu_protobuf_Payload_DataSet_DataSetValue_value {
        uint32_t int_value;
        uint64_t long_value;
        float float_value;
        double double_value;
...
typedef struct _org_eclipse_tahu_protobuf_Payload_PropertyValue {
    ...
    bool is_null;
    pb_size_t which_value;
    union _org_eclipse_tahu_protobuf_Payload_PropertyValue_value {
        uint32_t int_value;
        uint64_t long_value;
        float float_value;
        double double_value;
...
typedef struct _org_eclipse_tahu_protobuf_Payload_Metric {
    ...
    pb_size_t which_value;
    union _org_eclipse_tahu_protobuf_Payload_Metric_value {
        uint32_t int_value;
        uint64_t long_value;
        float float_value;
        double double_value;
